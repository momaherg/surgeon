...
This script properly loads NPT checkpoints by reconstructing the NPT architecture
before loading adapter weights, ensuring all NPT functionality works correctly.
"""
...
def main():
    ...
    # Load NPT model with proper architecture reconstruction
